...
require_once(dirname(__FILE__) . '/geoplugin.class.php');
...
//echo $platform;
$mydb = new DbConn();
$check_if_exists=$mydb->selectQry("SELECT ip FROM visitors_details WHERE ip = '$ip'");

if(mysqli_num_rows($check_if_exists)==0)
{
  $mydb->nonselectQry("INSERT INTO visitors_details VALUES ('','$city','$country','$ip','$browser','$os')");
}
